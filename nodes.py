...
class Florence2MoreDetailedCaption:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {
    ...
    "Florence2MoreDetailedCaption": Florence2MoreDetailedCaption,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "DownloadAndLoadFlorence2Model": "DownloadAndLoadFlorence2Model",
    "Florence2Run": "Florence2Run",
    "Florence2MoreDetailedCaption": "Florence2 MoreDetailedCaption",
}
